...
if($_SESSION['create_date'] != "" and $_SESSION['social'] !== "0"){
$sql = "(tg.CREATE_DATE >= '$_SESSION[create_date]' AND $like) AND (tg.SOCIAL = '$_SESSION[social]') AND $like";       
}
elseif($_SESSION['social'] !== "0" and $_SESSION['create_date'] == ""){

$sql = "(tg.SOCIAL = '$_SESSION[social]') AND $like";

}
if($_SESSION['create_date'] != "" and $_SESSION['social'] === "0"){

$sql = "(tg.CREATE_DATE >= '$_SESSION[create_date]') AND $like";

}
if($_SESSION['create_date'] == "" and $_SESSION['social'] === "0"){

$sql = "tg.ROLE NOT IN ('0') AND $like";
...
$data = db::arr("
SELECT * FROM tg_users tg WHERE $sql
LIMIT $start,10");
...
<div id="basic-1_wrapper" class="dataTables_wrapper no-footer">
    ...
    <table class="display dataTable no-footer" id="basic-1" role="grid" aria-describedby="basic-1_info">
        ...
        <?if($data != 'empty'):?>
            <? foreach ($data as $v):?>
                <? if($v['SOCIAL'] != 'acquaintances'){ $network = ucfirst($v['SOCIAL']); }else{ $network = ucfirst("tanishlar orqali"); } ?>
